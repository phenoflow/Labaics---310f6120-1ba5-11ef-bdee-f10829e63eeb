...
codes = [{"code":"51415","system":"gprdproduct"},{"code":"3546","system":"gprdproduct"},{"code":"54207","system":"gprdproduct"},{"code":"16236","system":"gprdproduct"},{"code":"8572","system":"gprdproduct"}];
REQUIRED_CODES = 1;
